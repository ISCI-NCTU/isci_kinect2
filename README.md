...
## Introduction
* This package was originally fork form [iai_kinect2](https://github.com/code-iai/iai_kinect2)
* Developed by [Thiemo Wiedemeyer](https://ai.uni-bremen.de/team/thiemo_wiedemeyer) <<wiedemeyer@cs.uni-bremen.de>>, [Institute for Artificial Intelligence](http://ai.uni-bremen.de/), University of Bremen
* Due to some modification and different configuration for the Kinect2 in ISCI Lab, we made some modification in this package,

## Maintainer

- [Howard Chen](https://github.com/s880367), Institute of Electrical Control Engineering, National Chiao Tung University, Taiwan


## Read this first -- Same as [iai_kinect2](https://github.com/code-iai/iai_kinect2) 
